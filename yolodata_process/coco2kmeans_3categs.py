...
class COCO:
    ...
    def parse(self, json_path):
        ...
        line = []
        line_tmp = []
        with open(r"C:\Users\Administrator\Desktop\yolodata_process\total_coco\kmeansdata.txt", "w") as fd:
...
if __name__ == '__main__':
    coco = COCO(r"C:\Users\Administrator\Desktop\yolodata_process\total_coco\JPEGImages")
    coco.parse(r"C:\Users\Administrator\Desktop\yolodata_process\total_coco\annotations.json")

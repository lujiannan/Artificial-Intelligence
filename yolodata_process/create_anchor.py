...
#        [138., 129.],
#        [168., 166.]])
def create_anchor(annotation_file_path, save_anchor_path):
    annotation_path = annotation_file_path  # "./data/my_data/sjht/sjht-train-new.txt"
    ...
    with open(save_anchor_path, "w") as fd:
        fd.write(anchor_string)
    print(anchor_string)
    return True
    # print('anchors are:')
    # print(anchor_string)
...
create_anchor(r"C:\Users\Administrator\Desktop\yolodata_process\total_coco\kmeansdata.txt",
              r"C:\Users\Administrator\Desktop\yolodata_process\total_coco\saved_anchor.txt")

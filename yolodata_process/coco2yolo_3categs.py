...
class COCO:
    ...
    def parse(self, json_path):
        ...
        line = []
        line_tmp = []
        with open("C:/Users/Administrator/Desktop/yolodata_process/total_coco/train.txt", "w") as fd:
...
if __name__ == '__main__':
    coco = COCO("C:/Users/Administrator/Desktop/yolodata_process/total_coco/JPEGImages")
    coco.parse("C:/Users/Administrator/Desktop/yolodata_process/total_coco/annotations.json")
